        ...
        >
            <View className='flex-row items-center'>
                <View className='flex-1 items-center'>
                    <View className='bg-yellow items-center justify-center rounded-lg px-4 py-4'>
                        <Text className='w-full text-center font-bold text-2xl uppercase tracking-[0.6px] text-black'>
                            Table:
                        </Text>
                        <Text className='w-full text-center text-xl font-bold text-black'>
                            {order.table}
                        </Text>
                    </View>
                </View>
